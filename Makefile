...
docs/mini_revisited.html: R/mini_revisited.Rmd \
						  ...
						  Blast/results_mini2/mini2_blastn_results.rds
	cd R;R $(R_OPTS) -e "rmarkdown::render('$(<F)')"
	mv R/$(@F) $@

Blast/results_mini2/mini2_blastn_results.rds: Blast/R/blastn_mini2.R Blast/R/minimuga2.fa
	cd $(<D);R $(R_OPTS) -e "source('$(<F)')"

Blast/R/minimuga2.fa: Blast/R/create_mini2_fasta.R Sequences/mini2_seq.csv
	cd $(<D);R $(R_OPTS) -e "source('$(<F)')"

Sequences/mini2_seq.csv: R/grab_minimuga2_sequences.R
