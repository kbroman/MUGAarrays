...
author: "Daniel Gatti and Belinda Cornes"
date: "10/5/2021"
output:
    html_document:
        toc: true
...
if(any(mmcvt_output$chr=="X")) {
    mmcvt_output[mmcvt_output$chr=="X", "cM_coxV3_ave"] <-
        mmcvt_output[mmcvt_output$chr=="X", "cM_coxV3_female"]
}
mmcvt_output = mmcvt_output[,c('marker', 'bp_grcm39', 'cM_coxV3_ave')]
...
chr_recomb = chr_recomb[,c('marker', 'chr', 'bp_grcm39', 'cM_coxV3_ave',
...
descriptions = c("Name of SNP marker",
                  ...
                  "Average cM position on Cox et al. map (female position on X chromosome)",
